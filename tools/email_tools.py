...
class EmailWriterTool(BaseTool):
    ...
    faq_db: Chroma = None  # Explicitly declare the attribute
    ...
    def __init__(self):
        ...
        # Load FAQs
        faq_loader = CSVLoader("./hyred_faq.csv", encoding="utf-8")
    ...
    def _run(self, latest_reply: str, conversation_history: str, sender: str):
        ...
        **INSTRUCTIONS:**
        ...
        - Format the output with HTML, must use <body style="color: #000000;">
        """
        # - If they ask for a call, insert this link: https://calendly.com/gethyred/learn-more-about-hyred?month=2025-02
        # """
        message = client.chat.completions.create(
            model="gpt-4o",
            messages=[
